class InvoiceComponent extends HTMLElement {
 ...
 render() {
  ...
  this.data.companyAddress.forEach((line) => {
    orgAddressDiv.appendChild(this.createElement("span", null, line));
  });
  ...
  this.data.customer.billing.address.forEach((line) => {
    billingAddressDiv.appendChild(this.createElement("span", null, line));
  });
  ...
  this.data.customer.shipping.address.forEach((line) => {
    shippingAddressDiv.appendChild(this.createElement("span", null, line));
  });
  ...
  loadStyles() {
    ...
    styleSheet.href = "style.css"; // Make sure this path is correct based on your project structure
